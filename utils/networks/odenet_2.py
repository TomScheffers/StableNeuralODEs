...
class OdeNet(nn.Module):
	def __init__(self, solver, integrator, t0, t1, steps, in_channels, channels, classes, mu=None, std=None):
		...
		self.solver1 = solver(self.gradient1, t0, t1, integrator, steps=steps, verbose=True)
		...
		self.solver2 = solver(self.gradient2, t0, t1, integrator, steps=steps)
		...
		self.solver3 = solver(self.gradient3, t0, t1, integrator, steps=steps) 
		...
		self.solver4 = solver(self.gradient4, t0, t1, integrator, steps=steps)            
