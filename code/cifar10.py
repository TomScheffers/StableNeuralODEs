...
from integrators.simple import Euler, ModifiedEuler, RungeKutta4, K2K3L1DistRungeKutta4, K2K3L2DistRungeKutta4, K2K3CosSimRungeKutta4
	...
	for i in range(3):
		...
		for e in range(epochs):
			...
			if test_acc.eval() >= best_acc:
				torch.save({'state_dict': model.state_dict()}, 'checkpoints/cifar10/' + model.solver1.name + "-" + model.solver1.method.name + "-" + post_fix + '.pth')
